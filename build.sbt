...
lazy val wartremover = Project(
  id = "wartremover",
  base = file("."),
  aggregate = Seq(sbtWartremover),
  settings = releaseSettings ++ assemblySettings ++ commonSettings ++ Seq(
    name := "wartremover",
    scalaVersion := "2.11.1",
...
lazy val sbtWartremover: Project = Project(
  id = "sbt-wartremover",
  base = file("sbt-wartremover"),
  settings = commonSettings ++ Seq(
    ...
    sourceGenerators in Compile <+= Def.task {
      ...
      val wartsDir = wartremover.base / "src" / "main" / "scala" / "wartremover" / "warts"
