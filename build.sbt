...
lazy val commonSettings = Def.settings(
  baseSettings,
  libraryDependencies ++= {
    Seq("org.scalatest" %% "scalatest-funsuite" % "3.2.17" % "test")
  },
...
val scoverage = "org.scoverage" % "sbt-scoverage" % "2.0.9" % "runtime" // for scala-steward
...
lazy val sbtPlug: Project = Project(
  ...
  libraryDependencies += "io.get-coursier" %% "coursier" % "2.1.8" % Test,
