  ...
  libraryDependencies ++= {
    if (scalaBinaryVersion.value == "3") {
      Seq(
        ...
        "io.get-coursier" % "coursier" % "2.1.17" % Test cross CrossVersion.for3Use2_13 exclude (
...
lazy val sbtPlug: Project = Project(
  ...
  libraryDependencies += "io.get-coursier" %% "coursier" % "2.1.17" % Test cross CrossVersion.for3Use2_13,
